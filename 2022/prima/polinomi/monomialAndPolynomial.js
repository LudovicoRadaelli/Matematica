function Monomial(sign, num, den, literal){
    ...
    //per scrivere la funzione su MathJax
    this.display = function() {
        ...
        if(this.den === 1) {
            if(this.num !==1){
            str += this.num;
            //QUA STA LA MODIFICA; FALLA ANCHE A TUTTI GLI ALTRI METODI
            } else {
                if(literal[0]===0 && literal[1]===0 && literal[2]===0 && literal[3]===0 && literal[4]===0 && literal[5]===0) {
                    str += this.num;
                }
            }
        } else {
