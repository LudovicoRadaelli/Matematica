function Monomial(sign, num, den, literal){
    ...
    this.num = num;
    this.den = den;
    //array contentente gli esponenti della parte letterale
    this.literal = literal;
    //array contenente le lettere tra cui scegliere
    ...
    this.redNumb = function() {
        ...
        if(this.den === 1) {
            ...
            str += "\\color{red}{\\frac{"+this.num+"}{"+this.den+"}}"
        }
...
function Polynomial(v) {
    ...
    this.display = function() {
        ...
        for(var i = 0; i < this.monomial.length; i++){
            if(i !== 0 && this.monomial[i].sign === 0) {
                str += "+";
                str += this.monomial[i].display();
            } else {
                str += this.monomial[i].display();
            }
        }
    ...
    this.redLett = function(m,l) {
        ...
        for(var i = 0; i < this.monomial.length; i++){
            if(i !== 0 && this.monomial[i].sign === 0) {
                if(i === m) {
                    str += "+";
                    str += this.monomial[i].redLett(redIndex);
                } else {
                    str += "+";
                    str += this.monomial[i].display();
                }
...
document.body.innerHTML += "<br>\\[\\begin{align*} \\frac{1}{2}x^{2}+2 = \\\\";
document.body.innerHTML += "= \\frac{1}{2}x^{2}+2 = \\\\";
document.body.innerHTML += "= \\frac{1}{2}x^{2}+2 = \\\\";
