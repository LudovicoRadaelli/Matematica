...
function show() {
    if(s === true) {
        document.getElementById("geogebra2").style.visibility = "visible";
    } else {
        document.getElementById("geogebra2").style.visibility = "hidden";
    }
    s = !s;
}
...
function changeValue() {
    ...
    document.getElementById("newRange").innerHTML = "<span style='color: blue;'>m</span>=<span style='color: blue;'>"+m+"</span>";  
}
