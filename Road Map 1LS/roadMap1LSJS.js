...
document.getElementById("sistemaNumerazioneRomana").addEventListener("click", function(){
    location.href = "https://ludovicoradaelli.github.io/Matematica/Road%20Map%201LP/roadMap1LS/NumeriNaturali/romanNumber.html";
});
document.getElementById("sistemaDiNumerazioneIndoArabo").addEventListener("click", function(){
    location.href = "https://ludovicoradaelli.github.io/Matematica/Road%20Map%201LP/roadMap1LS/NumeriNaturali/numericalBase10.html";
});
